    ...
    <form id="form1" runat="server">
        <p>
            <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style2">Donation Date</td>
                    <td class="auto-style3">
                        <asp:TextBox ID="DonationDate" runat="server" Width="191px"></asp:TextBox>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="auto-style3">
                        <asp:TextBox ID="District" runat="server" Width="191px"></asp:TextBox>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="auto-style2">&nbsp;</td>
                    <td class="auto-style3">
                        <asp:Button ID="DonateButton" runat="server" Text="Donate" Width="208px" OnClick="Button1_Click" />
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
